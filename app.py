...
@app.route("/b1_1")
def brightness_1():
    lamp1.set_brightness(1)
    return redirect(piip["pi4_ip"][0]["ip"])


@app.route("/b1_2")
def brightness_2():
    lamp1.set_brightness(2)
    return redirect(piip["pi4_ip"][0]["ip"])


@app.route("/b1_3")
def brightness_3():
    lamp1.set_brightness(3)
    return redirect(piip["pi4_ip"][0]["ip"])


@app.route("/b1_4")
def brightness_4():
    lamp1.set_brightness(4)
    return redirect(piip["pi4_ip"][0]["ip"])
...
def timer1_60():
    try:
        for i in range(1, 10):
            ...
            time.sleep(5)
        return redirect("http://192.168.86.31:6969")
...
@app.route("/b2_1")
def brightness2_1():
    lamp2.set_brightness(1)
    return redirect(piip["pi4_ip"][0]["ip"])


@app.route("/b2_2")
def brightness2_2():
    lamp2.set_brightness(2)
    return redirect(piip["pi4_ip"][0]["ip"])


@app.route("/b2_3")
def brightness2_3():
    lamp2.set_brightness(3)
    return redirect(piip["pi4_ip"][0]["ip"])


@app.route("/b2_4")
def brightness2_4():
    lamp2.set_brightness(4)
    return redirect(piip["pi4_ip"][0]["ip"])
